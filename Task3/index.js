...
for(let i=0;i<countriesInfo.length;i++)
{
    ...
    cName.innerText += "Name : "+countriesInfo[i].name;

    const cRegion = document.createElement("p");
    cRegion.innerText+= "Region : "+ countriesInfo[i].region;

    const cSubRegion = document.createElement("p");
    cSubRegion.innerText+="Sub Region : "+countriesInfo[i].subregion;

    const cPopulation = document.createElement("p");
    cPopulation.innerText+="Population : "+countriesInfo[i].population;

    countriesDetail.append(cName,cRegion,cSubRegion,cPopulation);
